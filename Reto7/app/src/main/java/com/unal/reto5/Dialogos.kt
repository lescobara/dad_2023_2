...
class Dialogos : DialogFragment(){
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        return when (dialogType) {
            ...
            DIALOG_TYPE_TREE -> createSocketDialog()
    ...
    private fun createSocketDialog():Dialog{
        // Create and return a default dialog
        val builder = AlertDialog.Builder(requireActivity())
        builder.setTitle("Conectarse a juego")
        builder.setMessage("Desea conectarse al servidor?")
        builder.setPositiveButton("Si") { dialog, _ ->
